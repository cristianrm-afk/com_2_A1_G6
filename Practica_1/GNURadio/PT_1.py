...
import PT_1_epy_block_1 as epy_block_1  # embedded python block
import sip
import threading



class PT_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "PT_1")
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_f((-5, -3, -1, 1, 3, 5), True, 1, [])
...
def main(top_block_cls=PT_1, options=None):
